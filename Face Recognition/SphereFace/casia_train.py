...
parser.add_argument('--marginFactor', type=int, default=4, help='margin factor')
...
parser.add_argument('--iterationDecreaseLR', type=int, nargs='+', default=[16000, 24000, 32000], help='the iteration to decrease learning rate')
